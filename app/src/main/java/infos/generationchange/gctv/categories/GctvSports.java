...
public class GctvSports extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gctv_sports);
        ...
        new GctvSports.FetchItems().execute();
    }
    ...
    private class FetchItems extends AsyncTask<String, Void, JSONArray> {
        protected JSONArray doInBackground(String... params) {
            ...
            HttpGet httpget = new HttpGet("https://dev.sdkgames.com/gctv/web/api/v01/gctv/contenu/5?_format=hal_json");
        ...
        protected void onPostExecute(JSONArray result) {
            ...
            LinearLayoutManager layoutManager = new LinearLayoutManager(GctvSports.this, RecyclerView.VERTICAL, false);
            recyclerView.setLayoutManager(layoutManager);
            //create the ArrayList to store the titles of nodes
            List<MainModel> listItems=new ArrayList<>();
            ...
            RecyclerViewAdapter ad= new RecyclerViewAdapter( listItems , GctvSports.this , 5);
