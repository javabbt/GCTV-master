...
public class GctvBusiness extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gctv_business);
        ...
        new GctvBusiness.FetchItems().execute();
    }
    ...
    private class FetchItems extends AsyncTask<String, Void, JSONArray> {
        protected JSONArray doInBackground(String... params) {
            ...
            HttpGet httpget = new HttpGet("https://dev.sdkgames.com/gctv/web/api/v01/gctv/contenu/2?_format=hal_json");
        ...
        protected void onPostExecute(JSONArray result) {
            ...
            LinearLayoutManager layoutManager = new LinearLayoutManager(GctvBusiness.this, RecyclerView.VERTICAL, false);
            ...
            RecyclerViewAdapter ad= new RecyclerViewAdapter( listItems , GctvBusiness.this , 2);
